namespace StudentManagementSystem.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            this.UserManager = userManager;//  ?? this.HttpContext.GetOwinContext().GetUserManager<ApplicationUserManager>();
            this.SignInManager = signInManager;//  ?? this.HttpContext.GetOwinContext().Get<ApplicationSignInManager>();
            this.authenticationManager = authenticationManager; //?? this.HttpContext.GetOwinContext().Authentication;
        }

        public ISignInManager<ApplicationUser> SignInManager { get; }
