namespace StudentManagementSystem.Authentication.MongoDb
{
    ...
    //{
    //    public RoleStore(IIdentityDatabaseContext<TUser, TRole, string> databaseContext) : base(databaseContext, normalizer, describer) { }
    //}
    ...
    //        if (await RoleDetailsAlreadyExists(role, cancellationToken))
    //        {
    //            return IdentityResult.Failed(string.Format("DuplicateRoleName {0}", role));
    //        }
